...
public class Vraboten extends Chovek implements Serializable {
    ...
    private ZonedDateTime datum_na_vrabotuvanje;

    public Vraboten() { }

    public Vraboten(String embg, String ime, String prezime, ZonedDateTime datum_na_ragjanje, String adresa_na_ziveenje, String telefonski_broj, ZonedDateTime datum_na_vrabotuvanje) {
